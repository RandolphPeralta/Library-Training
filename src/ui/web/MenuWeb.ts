...
export class MenuAccion {
  ...
  private registrarEstudiante() {
    const id = String(window.prompt("ID: "));
    const nombre = String(window.prompt("Nombre: "));
    const identificacion = String(window.prompt("Identificación: "));
    const grado = String(window.prompt("Grado: "));
  ...
  private buscarEstudiante() {
    const id = String(window.prompt("ID Estudiante: "));
  ...
  private registrarLibro() {
    const id = String(window.prompt("ID Libro: "));
    const titulo = String(window.prompt("Título: "));
    const autor = String(window.prompt("Autor: "));
  ...
  private elmiminarLibro() {
    const idLibro = String(window.prompt("ID Libro: "));
  ...
  private prestarLibrob() {
    const idLibro = String(window.prompt("ID Libro: "));
    const idEstudiante = String(window.prompt("ID Estudiante: "));
  ...
  private actualizarPrestamo(): void {
    ...
    // const id = String(window.prompt("ID del prestamo: "));
    ...
    // const fecha = window.prompt("Ingrese nueva fecha devolución (YYYY-MM-DD):")
